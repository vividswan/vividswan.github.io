...
![](/assets/images/200710-1.png){: .align-center width="600" height="400"}

Apache 하위 카테고리에서 다운로드한 버전의 Tomcat을 클릭해 주고 Next를 클릭해 준 뒤,<br>
![](/assets/images/200710-2.png){: .align-center width="600" height="400"}
다음 화면에서 Tomcat installation directory:에 다운로드한 zip 파일을 선택해 준다.<br>
![](/assets/images/200710-3.png){: .align-center width="600" height="400"}
마지막 finish를 누르기 전, JRE를 사용할 JRE로 바꿔주고 finish를 클릭한다
![](/assets/images/200710-4.png){: .align-center width="600" height="400"}
...
![](/assets/images/200710-5.png){: .align-center width="600" height="400"}
...
![](/assets/images/200710-6.png){: .align-center width="600" height="400"}
![](/assets/images/200710-7.png){: .align-center width="600" height="400"}
![](/assets/images/200710-8.png){: .align-center width="600" height="400"}
![](/assets/images/200710-9.png){: .align-center width="600" height="400"}
...
![](/assets/images/200710-10.png){: .align-center width="600" height="400"}
